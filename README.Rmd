...
- `RREOdata`: texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto.
...
# knitr::kable(Siconfi_data)

saveRDS(Siconfi_data, file = "Cod_instituicoes_siconfi")

readRDS(file = "Cod_instituicoes_siconfi")
```
-->
