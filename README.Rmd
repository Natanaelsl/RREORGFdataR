...
**RREORGFdataR** é um pacote R que permite aos usuários acessar facilmente conjuntos de dados fiscais... 
...
- `RGFdata`: texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto.
