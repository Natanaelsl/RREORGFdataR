...
test_that("check data.frame", {
  ...
  anexo2 <- RREORGFdataR::RGFdata(cod.ibge = 52, year = 2023, power = 'E', period = 1, annex = 2, simplified = FALSE)
  anexo3 <- RREORGFdataR::RGFdata(cod.ibge = 52, year = 2023, power = 'E', period = 1, annex = 3, simplified = FALSE)
...
test_that("check number of column", {
  ...
  testthat::expect_equal(ncol(anexo2), 15)
  testthat::expect_equal(ncol(anexo3), 15)
