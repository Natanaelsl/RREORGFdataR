...
test_that("check data.frame", {
  ...
  anexo1 <- RREORGFdataR::RGFdata(cod.ibge = 52, ano = 2023, poder = 'E', periodo = 1, anexo = 1, simplificado = FALSE)
  anexo2 <- RREORGFdataR::RGFdata(cod.ibge = 52, ano = 2023, poder = 'E', periodo = 2, anexo = 1, simplificado = FALSE)
  anexo3 <- RREORGFdataR::RGFdata(cod.ibge = 52, ano = 2023, poder = 'E', periodo = 3, anexo = 1, simplificado = FALSE)
