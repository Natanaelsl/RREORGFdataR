---
title: "RGF: Relatório de Gestão Fiscal"
output: 
  rmarkdown::html_vignette:
    df_print: "kable"
vignette: >
  %\VignetteIndexEntry{RGF: Relatório de Gestão Fiscal}
...
```{r ex1, eval = TRUE, message=FALSE, warning=FALSE, fig.width=7, fig.height=4}
...
```{r ex2, eval = TRUE, message=FALSE, warning=FALSE, fig.width=7, fig.height=4}
