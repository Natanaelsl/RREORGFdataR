...
```{r ex1-serie-historica, eval = TRUE, message=FALSE, warning=FALSE, fig.width=7, fig.height=4}
...
```{r ex2-comparacao-entes, eval = TRUE, message=FALSE, warning=FALSE, fig.width=7, fig.height=4}
